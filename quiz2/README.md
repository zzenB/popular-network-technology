...
The front end JS script has been fixed but somehow K8s doesn't rollout correctly (?) so the max file size is still 10 MB instead of 75 MB and there is some unintuitive behaviour of the button.
